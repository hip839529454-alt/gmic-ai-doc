...
export const COMPARISON_MODELS: ModelSpec[] = [
  // --- Microphone Devices ---
  {
    ...
    name: "Hearit.ai ChatMic",
    modelCode: "HA-MIC01B",
    dimensions: "45 × 19 × 21 mm",
    weight: "7g",
    material: "ABS",
    ...
    interactiveControl: "Physical mode switching button; 4 AI operation modes",
    appSupport: "Hearit.AI (iOS 11.0+ / Android 7.0+)",
    additionalFeatures: "Ultra-compact profile, low latency pairing",
    localStorage: "—",
    pickupAngle: "Directional"
  },
  {
    id: "ha-mic01c",
    category: "microphone-devices",
    ...
    distance: "10M",
    battery: "3.7V 80mAh",
    charging: "Type-C (5V / 150mA)",
    chargingTime: "1 hour",
    workingTime: "8 hours",
    microphone: "High-sensitivity omnidirectional condenser microphone",
    interactiveControl: "Front button, side button, buzzer",
    appSupport: "Hearit.AI (iOS 11.0+ / Android 7.0+)",
    additionalFeatures: "Standalone Offline Recording, USB Mass Storage Mode, ultra-lightweight wearable",
    localStorage: "128MB SPI NAND",
